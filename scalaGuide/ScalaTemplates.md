...
A Play Scala template is a simple text file, that contains small blocks of Scala code. They can generate any text-based format (HTML, XML, CSV, etc.).
...
Nothing special here. Simply use the standard `if` instruction from Scala:
