...
Play 2.0 uses [[logback | http://logback.qos.ch/]] as its logging engine. The default is to define two appenders, one dispatched to the standard out stream, and the other to the `logs/application.log` file.
