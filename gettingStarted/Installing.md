...
Once in the sbt console, run `build-repository` to compile and build everything. This will also create the local ivy repository containing all the required dependencies.

> Note that you don't need to install your own sbt version: Play 2.0 embed its own version (currently sbt 0.11.0).
